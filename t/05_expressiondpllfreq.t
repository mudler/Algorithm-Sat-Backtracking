...
use Algorithm::SAT::Backtracking::DPLLFreq;
...
subtest "or()" => sub {
    ...
    $expr = Algorithm::SAT::Expression->new->with(
        "Algorithm::SAT::Backtracking::DPLLFreq");
    my $prob = Algorithm::SAT::Backtracking::DPLLFreq->new;
...
subtest "_pure()/_pure_unit()" => sub {
    my $agent = Algorithm::SAT::Backtracking::DPLLFreq->new;
    ...
    $exp = Algorithm::SAT::Backtracking::DPLLFreq->new;
    my $impurity = [
        [ 'blue',  'green',  '-yellow' ],
        [ '-blue', '-green', 'yellow' ],
        [ 'pink', 'purple', 'green', 'blue', '-yellow' ],
