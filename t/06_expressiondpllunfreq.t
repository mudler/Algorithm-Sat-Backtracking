...
use Algorithm::SAT::Backtracking::DPLLUnFreq;
...
subtest "or()" => sub {
    ...
    $expr = Algorithm::SAT::Expression->new->with(
        "Algorithm::SAT::Backtracking::DPLLUnFreq");
    my $prob = Algorithm::SAT::Backtracking::DPLLUnFreq->new;
...
subtest "_pure()/_pure_unit()" => sub {
    my $agent = Algorithm::SAT::Backtracking::DPLLUnFreq->new;
    ...
    $exp = Algorithm::SAT::Backtracking::DPLLUnFreq->new;
    my $impurity = [
        [ 'blue',  'green',  '-yellow' ],
        [ '-blue', '-green', 'yellow' ],
        [ 'pink', 'purple', 'green', 'blue', '-yellow' ],
